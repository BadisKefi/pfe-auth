...
const MultiImageDropzoneTwo = React.forwardRef<HTMLInputElement, InputProps>(
  (
    {
      dropzoneOptions,
      value,
...
MultiImageDropzoneTwo.displayName = "MultiImageDropzoneTwo";
